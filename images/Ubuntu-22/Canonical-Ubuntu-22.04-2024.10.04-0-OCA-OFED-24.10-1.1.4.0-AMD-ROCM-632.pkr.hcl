...
variable "features" {
  type    = string
  default = "OCA-OFED-24.10-1.1.4.0-AMD-ROCM-632"
}
...
variable "build_options" {
  type    = string
  default = "noselinux,nomitigations,openmpi,benchmarks,amd,enroot,networkdevicenames,use_plugins"
}

variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2410_1140", "hpcx_2212", "openmpi_414", "amd_rocm_632", "oca_150_ubuntu"]
}
