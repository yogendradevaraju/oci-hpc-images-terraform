...
variable "base_image_name" {
  type    = string
  default = "(extended support) Oracle-Linux-7.9-2024.11.30-0"
} 
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_2310_2131", "hpcx_2180", "openmpi_414", "nvidia_550", "nvidia_cuda_12_6", "ol7_rhck" ]
}
