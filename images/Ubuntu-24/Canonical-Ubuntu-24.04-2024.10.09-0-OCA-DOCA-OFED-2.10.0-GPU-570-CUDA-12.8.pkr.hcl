...
variable "features" {
  type    = string
  default = "OCA-DOCA-OFED-2.10.0-GPU-570-CUDA-12.8"
}
...
variable "build_groups" {
  default = [ "kernel_parameters", "oci_hpc_packages", "mofed_doca_2100", "hpcx_2212", "openmpi_414", "nvidia_570", "nvidia_cuda_12_8", "oca_150_ubuntu"]
}
